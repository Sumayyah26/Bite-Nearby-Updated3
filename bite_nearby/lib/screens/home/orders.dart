...
class OrdersPage extends StatefulWidget {
  final String orderId; // Empty string means show all orders
  final String restaurantName;
  final bool showHistory; // New parameter for history view

  const OrdersPage({
    super.key,
    required this.orderId,
    required this.restaurantName,
    this.showHistory = false, // Default to false
  });
...
class _OrdersPageState extends State<OrdersPage> {
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      length: widget.orderId.isEmpty
          ? 2
          : 1, // Only show tabs when viewing all orders
      child: Scaffold(
        appBar: null,
          ...
          children: [
            ...
            Expanded(
              child: widget.orderId.isEmpty
                  ? TabBarView(
                      children: [
                        _buildOrderList(false), // Current orders
                        _buildOrderList(true), // Past orders
                      ],
                    )
                  : _buildOrderDetails(),
            ),
